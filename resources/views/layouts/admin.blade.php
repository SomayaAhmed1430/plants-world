            ...
            <ul>
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:block hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                            ...
                            <svg fill="#fff" viewBox="0 0 20 20" :class="{'rotate-180': open, 'rotate-0': !open}" class="inline w-4 h-4 mt-1 ml-1 transition-transform duration-200 transform md:-mt-1"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>
        ...
        <main class="m-2 p-8 w-full">
            <div>
                @if (session()->has('danger'))
                    <div role="alert" style="color: white; background-color: #f44336; margin-top: 1%; margin-right:10%; margin-left:10%; " class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:text-red-800">
                ...
                @if (session()->has('success'))
                    <div role="alert" style="color: white; background-color: green; margin-top: 1%; margin-right:10%; margin-left:10%; " class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:text-red-800">
                ...
                @if (session()->has('warning'))
                    <div role="alert" style="color: white; background-color: rgb(231, 233, 111); margin-top: 1%; margin-right:10%; margin-left:10%; " class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:text-red-800">
