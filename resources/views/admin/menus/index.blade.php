    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.menus.create') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white" style="background-color: #05796b">New Menu</a>
            </div>
                        ...
                        <tr
                            ...
                            <th scope="row"
                                ...
                                <div class="flex space-x-2">
                                    <a style="background-color: #05796b" href="{{ route('admin.menus.edit', $menu->id) }}" class="px-4 py-2 rounded-lg text-white">Edit</a>
